...
subscription_enhanced as (
    ...
    select
        *,
        ...
        row_number() over (partition by subscription_id {{ fivetran_utils.partition_by_source_relation(package_name='recurly') }} order by current_period_started_at) - 1 as subscription_period
