...
select 
    ...
    {{ dbt_utils.date_trunc('day', 'subscription_history.activated_at') }} as activation_date,
    subscription_history.add_ons_total, 
    {{ dbt_utils.date_trunc('day', 'subscription_history.canceled_at') }} as cancellation_date,
    {{ dbt_utils.date_trunc('day', 'subscription_history.current_period_ended_at') }} as current_period_end_date,
    {{ dbt_utils.date_trunc('day', 'subscription_history.current_period_started_at') }} as current_period_start_date,
    ...
    {{ dbt_utils.date_trunc('day', 'subscription_history.expires_at') }} as expiration_date,
    ...
    {{ dbt_utils.date_trunc('day', 'subscription_history.trial_ends_at') }} as trial_period_end_date,
    {{ dbt_utils.date_trunc('day', 'subscription_history.trial_started_at') }} as trial_period_start_date,
    ...
    {{ dbt_utils.date_trunc('day', 'account_overview.account_created_at') }} as account_created_date,
