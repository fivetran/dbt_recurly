...
- Intermediate models now materialize in their own schema named `recurly_intermediate`. This is to reduce noise in the schema for the final model outputs. ([#15](https://github.com/fivetran/dbt_recurly/pull/15))
## 🔧 Bug Fixes
